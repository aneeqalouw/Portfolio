<template>
  <div class="bg-black">
    <div class="container text-white bg-black" v-if="$store.state.testimonials">
      ...
      <br /><br />
      <section
        class="d-flex justify-content-center justify-content-evenly gap-5 flex-wrap my-4"
      >
        <div
          class="row"
